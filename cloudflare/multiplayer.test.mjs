...
test('Durable Object room creates, joins, relays and closes with the host', async (t) => {
  ...
  assert.deepEqual(await nextMessage(host, 'relayReady'), { type: 'relayReady', version: 6 });
  ...
  assert.deepEqual(await nextMessage(guest, 'relayReady'), { type: 'relayReady', version: 6 });
